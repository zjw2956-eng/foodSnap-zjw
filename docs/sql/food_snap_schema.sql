-- =====================================================
-- 美食分享社交平台 - 建表语句（完整独立脚本）
-- 数据库：foodSnap，字符集：utf8mb4
--
-- ⚠️ 此脚本与 hope-flyway 迁移保持同步：
--   V1.0.1__Add_initial_table.sql (sys_user)
--   V1.0.2__Add_food_snap_tables.sql (所有 food_* 表)
-- 日常开发用 Flyway 做版本迁移，此脚本仅用于新环境一次建库。
-- 如修改表结构，需同步更新 Flyway 迁移 + 此脚本。
-- =====================================================
